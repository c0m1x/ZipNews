...
- [x] **Swap canvas renderer for Leaflet.js (or MapLibre)**
...
- [x] **Migrate story markers to native map layer**
...
- [x] **Keep all existing filter & view controls**
...
- [x] **Match tile theme to dashboard colour scheme** *(nice-to-have)*
...
- [x] **Create a `/markets` route and page shell**
...
- [x] **Expand `/api/markets` with a wider instrument list**
...
- [x] **Add sparkline / mini-chart for each instrument**
...
- [x] **Build the instrument table with sortable columns**
...
- [x] **Keep the existing market strip on the main dashboard** *(no regression)*
...
- [x] **Auto-refresh markets page independently** *(nice-to-have)*
